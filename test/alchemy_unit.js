const alchemy = require('../lib/enricher/Alchemy');
...
describe('alchemy', function() {
  it('Alchemy Entities', function(done) {
    this.timeout(10000);
    var text2 =  'Hello, this is Stiles, he is best friends with Scott.'
    alchemy.alchemyEntities(text).then(function(result) {
  ...
  xit('Typed Relations', function(done) {
    this.timeout(10000);
    var text2 =  'Hello, this is Stiles, he is best friends with Scott.'
    alchemy.alchemyTypedRelations(text).then(function(result) {
      console.log('Result!', result);
      done()
    }).catch(function(error) {
      console.log('Error', error);
  ...
  xit('Combined Query', function(done) {
    this.timeout(10000);
    var text2 =  'Hello, this is Stiles, he is best friends with Scott.'
    alchemy.alchemyQuery(text).then(function(result) {
