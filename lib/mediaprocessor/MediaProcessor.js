...
const createGuid = function createGuid(filename) {
  return `${uuid.v1()}-${path.basename(filename)}`;
};

const isYoutube = link => (link.search('youtube') >= 0);
