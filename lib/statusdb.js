...
var getEnrichmentState = function getEnrichmentState(id, callback) {
  var viewName= 'entries';
  var params = {
    keys: [],
    include_docs: true
  }
  ...
  params.keys.push(id);
  db.view('state', viewName , params,  function(err, result) {
    if (err) {
